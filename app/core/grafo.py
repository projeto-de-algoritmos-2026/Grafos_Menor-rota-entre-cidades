...
def construir_grafico(cidades=None, arestas=None):
   
    cidades = cidades if cidades is not None else CIDADE
    arestas = arestas if arestas is not None else ARESTA

    grafico = {cidade: {} for cidade in cidades}
